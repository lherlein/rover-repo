...
void MPU6050::getOffsets(float *ax_off, float *ay_off, float *az_off, float *gr_off, float *gp_off, float *gy_off, int normalization_size = 1000) {
	...
	*ax_off = 0, *ay_off = 0, *az_off = 0; //Initialize the offsets to zero
	...
	for (int i = 0; i < normalization_size; i++) { //Use loop to average offsets
	...
	*gr_off = *gr_off / normalization_size, *gp_off = *gp_off / normalization_size, *gy_off = *gy_off / normalization_size; //Divide by number of loops (to average)
	*ax_off = *ax_off / normalization_size, *ay_off = *ay_off / normalization_size, *az_off = *az_off / normalization_size;
